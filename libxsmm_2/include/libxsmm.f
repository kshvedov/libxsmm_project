...
!=======================================================================!
     ...
     &    C_FUNPTR, C_NULL_FUNPTR, C_NULL_PTR
        ...
        CHARACTER(*), PARAMETER :: LIBXSMM_VERSION = "1.17-2251"
        ...
        INTEGER(C_INT), PARAMETER :: LIBXSMM_VERSION_MINOR = 17
        !> Update number based on the last reachable tag under RCS.
        INTEGER(C_INT), PARAMETER :: LIBXSMM_VERSION_UPDATE = 0
        !> Patch number counting commits since the last version stamp.
        INTEGER(C_INT), PARAMETER :: LIBXSMM_VERSION_PATCH = 2251
